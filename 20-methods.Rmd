...
To assess the scientific novelty of the readings assigned in each syllabus, we further linked the data to SciSciNet (v2) [@lin2023sciscinet], a large-scale database of scientific publications that includes pre-computed indicators of novelty, such as the atypicality measure introduced by Uzzi et al. [@uzzi2013atypical]. Matches were performed using article DOIs, corresponding to 80% of all readings with at least an available DOI in the readings. These matched publications appear in roughly 400,000 syllabi, representing about 14% of the 2.9 million syllabi containing reading lists.^[
