...
header-includes: |
  ...
  %\usepackage{endfloat} % nomarkers, nolists
  \usepackage{hyperref}
  \hypersetup{
    colorlinks=true,
    linkcolor=blue,
...
```{r, child = "sections/01-intro.Rmd"}
```

```{r, child = "sections/20-methods.Rmd"}
```

```{r, child = "sections/30-results.Rmd"}
```


```{r, child = "sections/40-discussion.Rmd"}
```


```{r, child = "sections/50-supporting.Rmd"}
```
